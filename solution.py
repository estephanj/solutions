            ...
            try:
                ...
                if types == 11:
                    ...
                    print(
                        ...
                        f"{ttl}", f"{howLongInSelect}", f"{addr}", f"Request timed out."
                    ...
                    if addr == destAddr:
                        ...
                        print(f"{ttl}", f"{howLongInSelect}", f"{addr}", f"{hostname}")



                        tracelist1.append(

                            [f"{ttl}", f"{howLongInSelect}", f"{addr}", f"{hostname}"]
                        ...
                        print(f"{ttl}", f"{howLongInSelect}", f"{addr}", f"{curr_name}")



                        tracelist1.append(

                            [f"{ttl}", f"{howLongInSelect}", f"{addr}", f"{curr_name}"]
